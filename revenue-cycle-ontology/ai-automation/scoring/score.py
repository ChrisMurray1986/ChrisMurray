...
def write_template(path, catalog):
    lines = [
        ...
        "#",
        "# What does a passing demo look like on YOUR stack (Epic, Oracle Health,",
        "# multi-EHR)? See ../14-implementation-patterns.md for per-facet sufficiency",
        "# floors and overbuild flags before scoring — or buying — anything.",
        "",
        "org:",
        "  name: \"<organization>\"",
