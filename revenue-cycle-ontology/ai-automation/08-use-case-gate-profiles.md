...
| 08-03 Appeal generation | D3·I3·C–·W3·O2·V2·E2·L2 | **Dependency**: CAP-04 payer-policy library + GOV-03 citation harness; **O**: reviewer throughput sized | DEFER without policy library (an LLM citing policies it can't retrieve is FM-AI-02 by design); pilot on one denial class |
