...
<footer>Source version <b>__VERSION__</b> — scores exported against a different version must be migration-checked. Generated by build_field_instrument.py from checklist.yaml + the function and role
...
def main():
    ...
    (HERE / "field-instrument.html").write_text(
        HTML.replace("__ITEMS__", json.dumps(items)).replace("__VERSION__", version))
