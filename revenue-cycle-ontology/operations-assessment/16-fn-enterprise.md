...
| PFM-11.4-02 | Exclusion screening (OIG/SAM) periodic, not continuous (11.4.A6) | Annual batch checks; hires between checks unscreened | PBP-11.4-02 Continuous exclusion monitoring, compliance-routed hits |
